...
const Footer = () => {
  ...
  return (
    <footer className="bg-base-100 max-w-[1300px] mx-auto dark:bg-gray-900 py-12 px-6 text-base-content relative">

      {/* Gradient Top Border */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-orange-500 via-pink-500 to-purple-700"></div>

      <div className="max-w-[1300px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
        ...
        <div>
          ...
          <p className="text-gray-400">Subscribe for updates on new artworks and events.</p>
        </div>
            ...
            {socialLinks.map((social) => (
              <div key={social.label} className="relative group">
                <a
                  ...
                  className="flex justify-center items-center w-12 h-12 rounded-full text-base-content bg-base-200 relative overflow-hidden transition-all duration-300 group-hover:text-white"
                >
                  <div
      ...
      {/* Footer Bottom */}
      <div className="mt-10 pt-6 text-center text-gray-400 relative z-10">
        <p className="text-sm">
