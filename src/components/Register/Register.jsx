...
import { Link, useNavigate } from 'react-router'; // <-- react-router only

const Register = () => {
  const { signInWithGoogle, setUser, updateUser, createUser } = useContext(AuthContext);
    ...
    <div className="flex justify-center items-center min-h-screen">
      ...
      >
        ...
        <div className="space-y-2">
          <h2 style={{ animation: 'appear 1.2s ease-out' }} className="text-center text-4xl font-extrabold text-white">
            Create Account
          </h2>
          <p style={{ animation: 'appear 1.8s ease-out' }} className="text-center text-gray-200">
        ...
        <form onSubmit={handleRegister} className="space-y-6">
          ...
          <div className="relative">
            ...
            {nameError && <p className="text-gray-900 text-sm mt-1">{nameError}</p>}
          </div>
          ...
          <div className="relative">
            ...
            {passwordError && <p className="text-gray-900 text-sm mt-1">{passwordError}</p>}
          </div>
        ...
        <button
          ...
          className="w-full py-2 bg-white hover:bg-gray-100 text-gray-900 rounded-lg font-semibold text-[18px] flex items-center justify-center gap-2"
        >
